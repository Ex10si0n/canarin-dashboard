...
//   //   items.forEach(function(item, index){
//   //     item.addEventListener("click", function() {
//   //       config.data.datasets[0].data = temperatureData[index].first;
//   //       config.data.datasets[1].data = temperatureData[index].second;
//   //       myLine.update();
//   //     });
//   //   });
//   // }
